...
output_dir_uniform="results_knowledge_base_uniform_experiment_fixed"
output_dir_linear="results_knowledge_base_linear_experiment_fixed"
output_dir_random="results_knowledge_base_random_experiment_fixed"
...
for i in $(seq 50 25 200); do
    for j in $(seq 10 5 70); do
        output_file="${output_dir_linear}/knowledge_base_${i}-${j}_linear-heuristic-bb.txt"
