...
output_dir_uniform="results_knowledge_base_uniform_experiment_fixed_jumpy"
output_dir_linear="results_knowledge_base_linear_experiment_fixed_jumpy"
output_dir_random="results_knowledge_base_random_experiment_fixed_jumpy"
