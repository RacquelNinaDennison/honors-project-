...
output_dir_uniform="results_knowledge_base_uniform_experiments"
output_dir_linear="results_knowledge_base_linear_experiments"
output_dir_random="results_knowledge_base_random_experiments"
